    ...
    >
      <template #body>
        <app-typography>
          ...
          fixed budget, scope uncertainties from the age of the building, and missing details in the
          design documents, all while staff remained fully operational throughout construction.
        </app-typography>
        <app-typography>
