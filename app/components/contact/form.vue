  ...
  <UForm :schema="schema" :state="state" class="space-y-4" @submit="onSubmit">
    <div class="grid grid-cols-1 gap-4">
      ...
      <UFormField label="Name" name="name" size="xl">
        <UInput v-model="state.name" class="w-full" placeholder="Your name" />
      </UFormField>

      <!-- Company -->
      <UFormField label="Company" name="company" class="w-full [&_label]:w-full" hint="Optional">
        <UInput v-model="state.company" class="w-full" placeholder="Company" size="xl" />
      </UFormField>
      ...
      <!-- Phone -->
      <UFormField label="Phone" name="phone" size="xl">
        <UInput
          v-model="state.phone"
          type="tel"
          inputmode="tel"
    ...
    <!-- Message -->
    <UFormField label="Message" name="message" size="xl" :hint="text_count">
      <UTextarea
    ...
    <app-button type="submit" color="primary" block> Submit </app-button>
  </UForm>
</template>
