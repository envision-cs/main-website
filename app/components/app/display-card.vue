  ...
  >
    <template #details>
      <div v-if="props.sector || props.completed" class="display-card__stats">
        <app-typography v-if="props.sector" tag="p" variant="text-sm">
          {{ props.sector }}
        </app-typography>
        <app-typography v-if="props.completed" tag="p" variant="text-sm">
          {{ props.completed }}
        </app-typography>
      </div>
    </template>
    <template #title>
      <app-typography tag="h3" :variant="props.heading" class="display-card__title">
        {{ props.title }}
      </app-typography>
    </template>
    <template #meta>
