...
<template>
  <component :is="tag" :href="href" :data-modal-open="modalId" class="card-control" :aria-label="ariaLabel"
    @click="handleClick">
    <div class="control-icon">
      <svg v-if="icon === 'plus'" class="icon" viewBox="0 0 36 36">
        <path
          d="M24 16.5h-4.5v-4.5a1.5 1.5 0 0 0-3 0v4.5H12a1.5 1.5 0 0 0 0 3h4.5v4.5a1.5 1.5 0 0 0 3 0v-4.5H24a1.5 1.5 0 0 0 0-3z" />
      </svg>
      <svg v-else class="icon" viewBox="0 0 36 36">
        <path
